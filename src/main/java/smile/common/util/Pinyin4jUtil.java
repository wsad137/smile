...
public class Pinyin4jUtil {
    ...
    public static String toPinying(String str) {
        ...
        for (char c : str.toCharArray()) {
            ...
            String[] pyChar = PinyinHelper.toHanyuPinyinStringArray(c);
            sb.append(getFirstLetter(str, pyChar));
        }
        return sb.toString();
    }

    private static char getFirstLetter(String str, String[] ch) {
        char def = 0;
        if (StringUtils.isEmpty(str)) return def;
        // TODO: 2016-05-31 多音字获取首字母
        return ch[0].charAt(0);
    }
...
//        String str = "长沙市长";
        ...
        System.out.println(toPinying(str));
    }
}